   ...
   <div class="container-fuild" style="background-color: #F4CC4C; display: flex; justify-content: space-around;">
       ...
       <div class="p-3">
           <!-- <button class="btn btn-outline-danger" style="float: right;"><i class="bi bi-box-arrow-right"></i>
               Logout</button> -->
           <a href="a_logout.php" class="btn btn-outline-danger" style="float: right;"><i
   ...
   <div class="container mt-2">
       <ul class="nav nav-pills nav-fill">
           ...
           <li class="nav-item">
               <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'casefile.php' ? 'active' : ''; ?>"
                   aria-current="page" href="casefile.php"><i class="bi bi-pencil-square"></i> New Case Filing</a>
           </li>
           <li class="nav-item">
