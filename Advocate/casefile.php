            ...
            <div class="mt-4">
                ...
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-md-6 ps-2">
                        ...
                        <input type="number" class="form-control" id="Number" placeholder="0987654321" maxlength="12"
        ...
        <div class="container boxtbl">
            ...
            <div class=" mt-4">
                ...
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-md-4 px-2">
                        <label for="inputZip" class="form-label">PIN Code:</label>
                        <input type="text" class="form-control" id="inputZip" placeholder="123456" name="rpin" min="3"
                            max="6" required>
                    </div>
                </div>
            </div>
